...
const pushSchema = z.object({
  body: z.object({
    collection: z.enum(['products', 'orders', 'categories', 'tables', 'deals', 'plans', 'members', 'payments', 'trainers', 'trainer_ledgers', 'measurements', 'customers', 'cash_shifts', 'pricing_tiers']),
    changeRows: z.array(
      z.object({
