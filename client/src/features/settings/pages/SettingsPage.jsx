            ...
            <div className="rounded-xl border border-border bg-card p-5 shadow-sm space-y-5">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-4 rounded-xl border border-border bg-muted/40">
                ...
                <button
                  onClick={handleScan}
                  disabled={scanning}
                  className="inline-flex items-center justify-center gap-1.5 rounded-lg border border-border bg-card hover:bg-muted px-4 py-2 text-xs font-bold transition-colors disabled:opacity-50 cursor-pointer text-foreground"
                >
            ...
            <div className="rounded-xl border border-border bg-card p-5 shadow-sm space-y-5">
              ...
              <div className="p-6 rounded-xl border border-dashed border-border bg-muted/20 flex flex-col items-center justify-center text-center space-y-3">
                ...
                <button
                  ...
                  className="bg-primary text-primary-foreground hover:opacity-95 font-bold rounded-lg px-4 py-2 text-xs transition-all cursor-pointer inline-flex items-center gap-1.5"
                >
            ...
            <div className="lg:col-span-7 rounded-xl border border-border bg-card p-5 shadow-sm space-y-4">
              ...
              {paymentMethods.length === 0 ? (
                <div className="p-8 border border-dashed border-border rounded-xl text-center">
                  <p className="text-xs text-muted-foreground">No custom payment methods configured. Use the form to add one.</p>
                </div>
              ) : (
            ...
            <div className="lg:col-span-5 rounded-xl border border-border bg-card p-5 shadow-sm space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-[10px] text-muted-foreground">Create gateway variables with real-time validation checks</p>
                </div>
                {editingId && (
                  <button
                    onClick={resetForm}
              ...
              <form onSubmit={handleFormSubmit} className="space-y-3.5">
                ...
                <div className="space-y-1">
                  ...
                  {getFieldStatus('accountTitle', accountTitle) === 'invalid' && (
                    <p className="text-[9px] text-red-500 font-bold font-mono">Title contains letters, numbers, spaces, dots, and dashes only (3-50 chars)</p>
                  )}
                </div>
