  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="rounded-xl border border-border dark:border-zinc-700 bg-white dark:bg-zinc-800 p-6 shadow-sm flex items-center justify-between transition-colors duration-300">
          ...
          <div className="rounded-full bg-emerald-500/10 p-3.5 text-emerald-600 dark:text-emerald-400 border border-emerald-500/20 dark:border-emerald-500/30 shrink-0 shadow-sm">
        ...
        <div className="rounded-xl border border-border dark:border-zinc-700 bg-white dark:bg-zinc-800 p-6 shadow-sm flex items-center justify-between transition-colors duration-300">
          ...
          <div className="rounded-full bg-amber-500/10 p-3.5 text-amber-600 dark:text-amber-400 border border-amber-500/20 dark:border-amber-500/30 shrink-0 shadow-sm">
