    ...
    <div className="rounded-xl border border-border bg-card shadow-sm overflow-hidden flex flex-col h-full">
      <div className="p-6 border-b border-border bg-slate-50/50 dark:bg-zinc-800/10">
        <h2 className="text-lg font-bold tracking-tight text-foreground flex items-center gap-2">
          ...
          <span>Device Approval Queue</span>
        </h2>
        <p className="text-xs text-muted-foreground mt-0.5">Approve whitelisted hardware fingerprints for tenant nodes</p>
      </div>
                  ...
                  <td className="py-3.5 px-4 text-right">
                    <div className="inline-flex items-center gap-1.5">
                      <button
                        ...
                        className="inline-flex items-center gap-1 rounded-md bg-green-500/10 hover:bg-green-500/20 text-green-600 dark:text-green-400 px-2.5 py-1.5 text-xs font-bold transition-colors border border-green-500/20 disabled:opacity-50"
                      ...
                      <button
                        ...
                        disabled={approveDeviceMutation.isPending}
                        className="inline-flex items-center gap-1 rounded-md bg-red-500/10 hover:bg-red-500/20 text-red-600 dark:text-red-400 px-2.5 py-1.5 text-xs font-bold transition-colors border border-red-500/20 disabled:opacity-50"
                        title="Reject Device"
                      >
