...
const AnalyticsContent = ({ totalRevenue, totalOrders, avgOrderValue, topProducts }) => (
  <div className="space-y-6">
    ...
    <div className="rounded-2xl border border-border bg-card p-6 shadow-sm space-y-6">
      <div className="flex items-start justify-between gap-4">
        ...
        {totalOrders > 0 && (
          <span className="text-xs font-bold text-muted-foreground bg-muted px-2.5 py-1 rounded-full shrink-0 tabular-nums">
